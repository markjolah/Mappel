...
class TestModel1DVariableSigma : public ::testing::Test {
public:    
    Model model;
    TestModel1DVariableSigma() : model(make_model<Model>()) {}
    virtual void SetUp() {
        env->reset_rng();
...
TYPED_TEST(TestModel1DVariableSigma, min_max_sigma_bounds_1D) {
