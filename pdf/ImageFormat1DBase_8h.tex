...
Include dependency graph for Image\+Format1\+D\+Base.\+h\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{ImageFormat1DBase_8h__incl}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{ImageFormat1DBase_8h__dep__incl}
\end{center}
\end{figure}
