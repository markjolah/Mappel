...
Include dependency graph for openmp\+\_\+methods.\+h\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{openmp__methods_8h__incl}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{openmp__methods_8h__dep__incl}
\end{center}
\end{figure}
