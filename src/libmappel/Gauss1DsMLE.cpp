...
Gauss1DsMLE::Gauss1DsMLE(arma::Col<ImageCoordT> size, VecT min_sigma, VecT max_sigma, const std::string &prior_type)
    : Gauss1DsMLE(size(0),make_default_prior(size(0),min_sigma(0),max_sigma(0),prior_type))
{ }

Gauss1DsMLE::Gauss1DsMLE(ImageSizeT size, double min_sigma, double max_sigma, const std::string &prior_type)
    : Gauss1DsMLE(size,make_default_prior(size,min_sigma,max_sigma,prior_type))
{ }
